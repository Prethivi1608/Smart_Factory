...
class RobotMove(Node):
    ...
    def robot_left(self):
        self.left_msg = Twist()
        self.left_msg.linear.x = 0.01
        self.left_msg.angular.z = 1.0
